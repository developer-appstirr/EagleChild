package com.example.eagle_child.vpn;
...
public class VpnServicee extends VpnService
{

	public static final String VPN_ADDRESS = "192.168.18.44";
	private static final String VPN_ROUTE = "0.0.0.0";
	private static final String VPN_DNS = "192.168.18.1";
	...
	private boolean setupVPN()
	{
		try
		{
			if (vpnInterface == null)
			{
				...
				Intent configure = new Intent(this, HomeActivity.class);
